...
1. **M.G.L. c. 41, § 111F** — pays full salary (tax-free) and medical expenses to a police officer or firefighter while *incapacitated from duty* by a job-related injury. Tied to active-employee status; terminates on retirement.
2. **M.G.L. c. 41, § 100** — a separate, freestanding municipal duty to **indemnify** police officers and firefighters for reasonable medical, surgical, and hospital expenses incurred as a result of injuries sustained in the performance of duty. This obligation is *not* extinguished by retirement.
...
1. **Setup phase (this phase):** project.md, claude.md, memory.md, intake checklist, CBA capture
2. **Statutory memo:** Detailed §111F vs §100 distinction with full statutory text and analysis
3. **Case law memo:** *Wormstead* and progeny, post-retirement §100 cases, involuntary ADR process cases
4. **CBA analysis:** Provisions on IOD, medical reimbursement, grievance, past practice
5. **Process memo:** What the Town must do procedurally to retire John involuntarily, and where the leverage points are
6. **§101 lump sum analysis:** Whether this option applies and how it interacts with §100
7. **Strategic summary:** Consolidated brief John can hand to a labor attorney
